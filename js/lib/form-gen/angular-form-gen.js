...
(function (angular) {
  ...
  fg.config(["fgConfigProvider", "FgField", function (fgConfigProvider, FgField) {
    ...
    var categories = {
      'Text input fields': [
        new FgField('beschriftung', { displayName: 'Beschriftung' }),
        new FgField('date', { displayName: 'Datum' }),
        // new FgField('time', { displayName: 'Zeit' }),
        new FgField('text', { displayName: 'Textfeld' }),
        new FgField('email', { displayName: 'E-Mail' }),
        new FgField('upload', { displayName: 'Upload' }),
        new FgField('number', {
          displayName: 'Zahl',
          validation: { maxlength: 15 /* to prevent > Number.MAX_VALUE */ }
        }),
        // new FgField('password', {displayName: 'Passwort'}),
        new FgField('textarea', { displayName: 'Textbereich' })
      ],
      'Checkbox fields': [
        new FgField('checkbox', { nolabel: true }),
        new FgField('checkboxlist', {
          displayName: 'Check Liste',
          options: [
            {
              value: '1',
              text: 'Option 1'
  ...
  angular.module('fg').run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('angular-form-gen/field-templates/default/dropdownlist.ng.html', '<div fg-field-input=\"\" fg-dropdown-input=\"field.schema.options\" title=\"{{ field.schema.tooltip }}\" id=\"{{ field.$_id }}\" ng-model=\"form.data[field.schema.name]\"  tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ></div>');
    $templateCache.put('angular-form-gen/field-templates/default/email.ng.html', '<input class=\"form-control\" fg-field-input=\"\" type=\"email\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\"  >');
    $templateCache.put('angular-form-gen/field-templates/default/upload.ng.html', '<input readonly class=\"form-control\" fg-field-input=\"\" type=\"email\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\"  >');
    ...
    $templateCache.put('angular-form-gen/field-templates/default/number.ng.html', '<input class=\"form-control\" fg-field-input=\"\" fg-input-number=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\"  ng-model=\"form.data[field.schema.name]\"  ng-minlength=\"{{ field.schema.validation.minlength }}\">');
    $templateCache.put('angular-form-gen/field-templates/default/password.ng.html', '<input class=\"form-control\" fg-field-input=\"\" type=\"password\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" >');
    ...
    $templateCache.put('angular-form-gen/field-templates/properties/selectlist.ng.html', '<div fg-tabs-pane=\"Einstellungen\"><div fg-property-field-common=\"{ fieldname: false, displayname: true, tooltip: true }\"></div></div><div fg-tabs-pane=\"Optionen\"><div fg-property-field-options=\"\"></div></div><div fg-tabs-pane=\"Prüfung\"><div fg-property-field-validation=\"{ required: true }\"></div></div>');
    ...
    $templateCache.put('angular-form-gen/field-templates/properties/beschriftung.ng.html', '<div fg-tabs-pane=\"Einstellungen\"><div fg-property-field-common=\"{ fieldname: false, displayname: false, placeholder: false, tooltip: false }\"></div><div fg-property-field-value=\"\"><textarea name=\"fieldValue\" class=\"form-control\" ng-model=\"field.value\"></textarea></div></div></div>');
    ...
    $templateCache.put('angular-form-gen/edit/palette/categories/categories.ng.html', '');
    ...
    $templateCache.put('angular-form-gen/edit/canvas/field/properties/property-field/field-value.ng.html', '<div ng-if=\"draw\"><div fg-property-field=\"fieldValue\" fg-property-field-label=\"Initialwert\"><div ng-transclude=\"\"></div></div></div>');
    ...
    $templateCache.put('angular-form-gen/field-templates/properties/date.ng.html', `<div fg-tabs-pane="Einstellungen">
    <div fg-property-field-common="{ fieldname: false, displayname: true, placeholder: true, tooltip: true }"></div></div>`);
    $templateCache.put('angular-form-gen/field-templates/properties/text.ng.html', '<div fg-tabs-pane=\"Einstellungen\"><div fg-property-field-common=\"{ fieldname: false, displayname: true, placeholder: true, tooltip: true }\"></div><div fg-property-field-value=\"\"><input type=\"text\" class=\"form-control\" name=\"fieldValue\" ng-model=\"field.value\" ng-minlength=\"{{ field.validation.minlength }}\" ng-maxlength=\"{{ field.validation.maxlength }}\" ng-pattern=\"{{ field.validation.pattern }}\"></div></div><div fg-tabs-pane=\"Prüfung\"><div fg-property-field-validation=\"{ required: true, minlength: true, maxlength: true, pattern: false }\"></div></div>');
  }]);
